        ...
        this.$get = ['$modal', function($modal) {
            return {
                error: function(header, msg) {
                    return $modal.open({
                        templateUrl: '/views/partials/modals/dialogs-error',
                ...
                wait: function(header, msg, progress) {
                    return $modal.open({
                        templateUrl: '/views/partials/modals/dialogs-wait',
                ...
                notify: function(header, msg) {
                    return $modal.open({
                        templateUrl: '/views/partials/modals/dialogs-notify',
                ...
                confirm: function(header, msg, isError) {
                    return $modal.open({
                        templateUrl: '/views/partials/modals/dialogs-confirm',
